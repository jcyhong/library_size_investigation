...
show_plot(otu, df_sample, "sample_name", "atherosclerosis", "TSS", write = WRITE)
show_plot(otu, df_sample, "sample_name", "atherosclerosis", "GMPR", write = WRITE)
show_plot(otu, df_sample, "sample_name", "atherosclerosis", "CSS", write = WRITE)
...
show_plot(otu, df_sample, "sample_name", "chronic_condition", "TSS", write = WRITE)
show_plot(otu, df_sample, "sample_name", "chronic_condition", "GMPR", write = WRITE)
show_plot(otu, df_sample, "sample_name", "chronic_condition", "CSS", write = WRITE)

show_plot(otu, df_sample, "sample_name", "diabetes", "TSS", write = WRITE)
show_plot(otu, df_sample, "sample_name", "diabetes", "GMPR", write = WRITE)
show_plot(otu, df_sample, "sample_name", "diabetes", "CSS", write = WRITE)

show_plot(otu, df_sample, "sample_name", "hypertension", "TSS", write = WRITE)
show_plot(otu, df_sample, "sample_name", "hypertension", "GMPR", write = WRITE)
show_plot(otu, df_sample, "sample_name", "hypertension", "CSS", write = WRITE)
...
show_plot(otu, df_sample, "sample_name", "smoker", "TSS", write = WRITE)
show_plot(otu, df_sample, "sample_name", "smoker", "GMPR", write = WRITE)
show_plot(otu, df_sample, "sample_name", "smoker", "CSS", write = WRITE)
