...
show_plot(otu, df_sample, "id", "aggsize", "TSS", write = WRITE)
show_plot(otu, df_sample, "id", "aggsize", "GMPR", write = WRITE)
show_plot(otu, df_sample, "id", "aggsize", "CSS", write = WRITE)

# pch and color corresponds to aggsize grouping.
