...
show_plot(otu, df_sample, "sample_name", "body_habitat", "TSS", write = WRITE)
show_plot(otu, df_sample, "sample_name", "body_habitat", "GMPR", write = WRITE)
show_plot(otu, df_sample, "sample_name", "body_habitat", "CSS", write = WRITE)

show_plot(otu, df_sample, "sample_name", "env_feature", "TSS", write = WRITE)
show_plot(otu, df_sample, "sample_name", "env_feature", "GMPR", write = WRITE)
show_plot(otu, df_sample, "sample_name", "env_feature", "CSS", write = WRITE)
...
show_plot(otu, df_sample, "sample_name", "storage_days", "TSS", write = WRITE)
show_plot(otu, df_sample, "sample_name", "storage_days", "GMPR", write = WRITE)
show_plot(otu, df_sample, "sample_name", "storage_days", "CSS", write = WRITE)

show_plot(otu, df_sample, "sample_name", "storage_temp", "TSS", write = WRITE)
show_plot(otu, df_sample, "sample_name", "storage_temp", "GMPR", write = WRITE)
show_plot(otu, df_sample, "sample_name", "storage_temp", "CSS", write = WRITE)
