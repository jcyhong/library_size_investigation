...
WRITE = F
##########################################
show_plot(otu, df_sample, "sample_name", "diet", "TSS", write = WRITE)
show_plot(otu, df_sample, "sample_name", "diet", "GMPR", write = WRITE)
show_plot(otu, df_sample, "sample_name", "diet", "CSS", write = WRITE)

show_plot(otu, df_sample, "sample_name", "gender", "TSS", TRUE, write = WRITE)
show_plot(otu, df_sample, "sample_name", "gender", "GMPR",TRUE,  write = WRITE)
show_plot(otu, df_sample, "sample_name", "gender", "CSS", TRUE, write = WRITE)

show_plot(otu, df_sample, "sample_name", "host_age", "TSS", write = WRITE)
show_plot(otu, df_sample, "sample_name", "host_age", "GMPR", write = WRITE)
show_plot(otu, df_sample, "sample_name", "host_age", "CSS", write = WRITE)
