...
show_plot(otu, df_sample, "sample_name", "age_range", "GMPR2", "demographics", TRUE, write = WRITE)
...
show_plot(otu, df_sample, "sample_name", "bmi_class", "GMPR2", "demographics", TRUE, write = WRITE)
...
show_plot(otu, df_sample, "sample_name", "city", "GMPR2", "geo_loc", TRUE, write = WRITE)
...
show_plot(otu, df_sample, "sample_name", "medicament", "GMPR2", "disease", FALSE, write = WRITE)
...
show_plot(otu, df_sample, "sample_name", "stool_consistency", "GMPR2", "body_site", FALSE, write = WRITE)
