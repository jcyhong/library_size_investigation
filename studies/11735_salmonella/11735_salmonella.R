...
path_to_data <- "~/Documents/UC Berkeley/spring2020/Researches/librarysize/DATA/11735_salmonella/53090_otu_table.biom"
...
dim(otu) # 570 taxa and 207 samples (rows)
taxa_are_rows(otu) # taxa are rows (so observations are columns), 


df_sample <- read.table('~/Documents/UC Berkeley/spring2020/Researches/librarysize/DATA/11735_salmonella/11735_20180510-131235.txt', header=TRUE, sep='\t')
...
show_plot(otu, df_sample, "sample_name", "treatment", "TSS", "disease", TRUE, write = WRITE)
show_plot(otu, df_sample, "sample_name", "treatment", "GMPR2", "disease", TRUE, write = WRITE)
show_plot(otu, df_sample, "sample_name", "treatment", "CSS", "disease", TRUE, write = WRITE)
# 
