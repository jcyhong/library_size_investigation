...
show_plot(otu, df_sample, "sample_name", "carbon_substrate", "TSS", write = WRITE)
show_plot(otu, df_sample, "sample_name", "carbon_substrate", "GMPR", write = WRITE)
show_plot(otu, df_sample, "sample_name", "carbon_substrate", "CSS", write = WRITE)
