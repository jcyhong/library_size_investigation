...
WRITE = TRUE
##########################################
show_plot(otu, df_sample, "sample_name", "hispanic_origin", "TSS", write = WRITE)
show_plot(otu, df_sample, "sample_name", "hispanic_origin", "GMPR", write = WRITE)
show_plot(otu, df_sample, "sample_name", "hispanic_origin", "CSS", write = WRITE)

show_plot(otu, df_sample[df_sample$diabetes_self_v2!="not provided",], "sample_name", "diabetes_self_v2", "TSS", write = WRITE)
show_plot(otu, df_sample[df_sample$diabetes_self_v2!="not provided",], "sample_name", "diabetes_self_v2", "GMPR", write = WRITE)
show_plot(otu, df_sample[df_sample$diabetes_self_v2!="not provided",], "sample_name", "diabetes_self_v2", "CSS", write = WRITE)

show_plot(otu, df_sample, "sample_name", "us_born_v2", "TSS", write = WRITE)
show_plot(otu, df_sample, "sample_name", "us_born_v2", "GMPR", write = WRITE)
show_plot(otu, df_sample, "sample_name", "us_born_v2", "CSS", write = WRITE)

show_plot(otu, df_sample, "sample_name", "education_c3_v2", "TSS", write = WRITE)
show_plot(otu, df_sample, "sample_name", "education_c3_v2", "GMPR", write = WRITE)
show_plot(otu, df_sample, "sample_name", "education_c3_v2", "CSS", write = WRITE)
